...
** N = 1000, informative start
(1000.0,[1000.0,1000.0],[-2.5165199728997107,2.502110379617441],[1.9493298589640817,0.10017664323479762])
 132,886,805,288 bytes allocated in the heap
  55,540,403,064 bytes copied during GC
     317,981,016 bytes maximum residency (252 sample(s))
       5,245,248 bytes maximum slop
             303 MB total memory in use (0 MB lost due to fragmentation)

                                     Tot time (elapsed)  Avg pause  Max pause
  Gen  0     127035 colls, 127035 par   168.496s  54.035s     0.0004s    0.0118s
  Gen  1       252 colls,   251 par   24.041s   6.245s     0.0248s    0.1045s

  Parallel GC work balance: 32.48% (serial 0%, perfect 100%)
  ...
  MUT     time   53.839s  ( 65.316s elapsed)
  GC      time  192.538s  ( 60.280s elapsed)
  EXIT    time    0.001s  (  0.004s elapsed)
  Total   time  246.380s  (125.601s elapsed)

  Alloc rate    2,468,218,857 bytes per MUT second

  Productivity  21.9% of total user, 52.0% of total elapsed
...
Compilation finished at Sat Dec 14 17:20:17
